...
/** GUI icon management **/
$tlCfg->icon = array('active' =>  'flag_green.png',
		'activity' =>  'information.png',
		'add' =>  'add.png',
		'api_info' =>  'brick.png',
		'bug' =>  'bug.png',
		'bug_link_tl_to_bts' =>  'bug_link_famfamfam.png',
		'bug_create_into_bts' =>  'bug_add_famfamfam.png',
		'bug_link_tl_to_bts_disabled' =>  'bug_link_disabled_famfamfam.png',
		'bug_create_into_bts_disabled' =>  'bug_add_disabled_famfamfam.png',
		'bug_add_note' =>  'bug_edit.png',
		'bullet' =>  'slide_gripper.gif',
		'calendar' =>  'calendar.gif',
		'checked' =>  'apply_f2_16.png',
		'choiceOn' =>  'accept.png',
		'clear' =>  'trash.png',
		'clear_notes' =>  'font_delete.png',
		'check_ok' =>  'lightbulb.png',
		'check_ko' =>  'link_error.png',
		'cog'  =>  'cog.png',
		'create_copy' =>  'application_double.png',
		'create_from_xml' =>  'wand.png',
		'date' =>  'date.png',
		'delete' =>  'trash.png',
		'demo_mode' =>  'emoticon_tongue.png',
		'delete_disabled' =>  'trash_greyed.png',
		'disconnect' =>  'disconnect.png',
		'disconnect_small' =>  'disconnect_small.png',
		'direct_link' =>  'world_link.png',
		'duplicate' =>  'application_double.png',
		'edit' =>  'icon_edit.png',
		'edit_icon' =>  'edit_icon.png',
		'events' =>  'bell.png',
		'eye' =>  'eye.png',
		'vorsicht' =>  'exclamation.png',
		'export' => 'export.png',
		'export_import' =>  'export_import.png',
		'execute' =>  'lightning.png',
		'executed' =>  'lightning.png',
		'exec_icon' =>  'exec_icon.png',
		'exec_passed' =>  'emoticon_smile.png',
		'exec_failed' =>  'emoticon_unhappy.png',
		'exec_blocked' =>  'emoticon_surprised.png',
		'execution' =>  'controller.png',
		'execution_order' =>  'timeline_marker.png',
		'export_excel' =>  'page_excel.png',
		'export_for_results_import' =>  'brick_go.png',
		'ghost_item' =>  'ghost16x16.png',
		'history' =>  'history.png',
		'history_small' =>  'history_small.png',
		'home' =>  'application_home.png',
		'import' =>  'door_in.png',
		'import_results' =>  'monitor_lightning.png',
		'inactive' =>  'flag_yellow.png',
		'info' =>  'question.gif',
		'info_small' =>  'information_small.png',
		'insert_step' =>  'insert_step.png',
		'item_link' =>  'folder_link.png',
		'link_to_report' =>  'link.png',
		'lock' =>  'lock.png',
		'lock_open' =>  'lock_open.png',
		'log_message' =>  'history.png',
		'log_message_small' =>  'history_small.png',
		'magnifier' =>  'magnifier.png',
		'move_copy' =>  'application_double.png',
		'note_edit' =>  'note_edit.png',
		'note_edit_greyed' =>  'note_edit_greyed.png',
		'on' =>  'lightbulb.png',
		'off' =>  'lightbulb_off.png',
		'order_alpha' =>  'style.png',
		'public' =>  'door_open.png',
		'private' =>  'door.png',
		'question' => 'sym_question.gif',
		'remove' =>  'delete.png',
		'reorder' =>  'arrow_switch.png',
		'report' =>  'report.png',
		'report_word' =>  'page_word.png',
		'requirements' =>  'cart.png',
		'resequence' =>  'control_equalizer.png',
		'summary_small' =>  'information_small.png',
		'sort' =>  'sort_hint.png',
		'steps' =>  'bricks.png',
		'table' =>  'application_view_columns.png',
		'testcases_table_view' =>  'application_view_columns.png',
		'testcase_execution_type_automatic' =>  'bullet_wrench.png',
		'testcase_execution_type_manual' =>  'user.png',
		'test_specification' =>  'chart_organisation.png',
		'toggle_all' => 'toggle_all.gif',
		'user' =>  'user.png',
		'upload' =>  'upload_16.png',
		'upload_greyed' =>  'upload_16_greyed.png',
		'warning' =>  'error_triangle.png',
		'wrench' =>  'wrench.png',
		
		/******************************************************************/
		//Mainbar
		'mainbar_user' => 'mainbar_usexec_history_note_editer.png',
		'mainbar_logout' => 'mainbar_logout.png',
		'mainbar_home' => 'mainbar_home.png',
		'mainbar_reqs' => 'mainbar_reqs.png',
		'mainbar_testspec' => 'mainbar_testspec.png',
		'mainbar_testexec' => 'mainbar_testexec.png',
		'mainbar_reports' => 'mainbar_reports.png',
		'mainbar_useroles' => 'mainbar_useroles.png',
		'mainbar_events' => 'mainbar_events.png',

		//NavBar
		'navbar_account' =>  'navbar_account.png',
		'navbar_logout' =>  'navbar_logout.png',
		
		//Test specification
		'specs_tso_create' => 'tso_create.png',
		'specs_tso_edit' => 'tso_edit.png',
		'specs_tso_copymove' => 'tso_copymove.png',
		'specs_tso_delete' => 'tso_delete.png',
		'specs_tso_sort_alpha' => 'tso_alpha_sort.png',
		'specs_tso_table_view' => 'tso_table_view.png',
		'specs_tso_report' => 'report_HTML.png',
		'specs_tso_word' => 'report_Word.png',
		'specs_tso_import' => 'tso_import.png',
		'specs_tso_export' => 'tso_export.png',
		'specs_tco_create' => 'tso_create.png',
		'specs_tco_copymove' => 'tso_copymove.png',
		'specs_tco_delete' => 'tso_delete.png',
		'specs_tco_sort' => 'tco_sort_external_ID.png',
		'specs_tco_import' => 'tso_import.png',
		'specs_tco_export' => 'tso_export.png',
		'specs_tco_create_from_issues' => 'tco_create_from_issues.png',


		//Test exec
		'exec_export_testplan' => 'exec_export_testplan.png',
		'exec_export_for_import' => 'exec_export_results.png',
		'exec_import' => 'exec_import_results.png',

		//Exec history
		'exec_history_note_edit' => 'note_edit.png',
		'exec_history_lock' => 'lock.png',
		'exec_history_user' => 'user.png',
		'exec_history_execution_type' => 'bullet_wrench.png',
		
		//OptionTransfer
		'ico_all_l' => 'ico_all_l.gif',
		'ico_all_r' => 'ico_all_r.gif',
		'ico_l2r.gif' => 'ico_l2r.gif',
		 'ico_l2l.gif' => 'ico_l2l.gif',

		//Inventory
		'inventory_copy' => 'data_copy_16.png',
		'inventory_new' => 'data_new_16.png',
		'inventory_delete' => 'data_delete_16.png',
		'inventory_edit' => 'data_edit_16.png',
		
		//Apply button
		'apply_16px' => 'apply_f2_16.png',
		'apply' => 'apply_f2.png',
