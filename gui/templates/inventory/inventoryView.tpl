...
{include file="inc_del_onclick.tpl"}
  	...
  	<style type="text/css">
		.icon_device_copy {ldelim}background-image:url({$basehref}{$tlImages.inventory_copy}) !important;{rdelim}
		.icon_device_create {ldelim}background-image:url({$basehref}{$tlImages.inventory_new}) !important;{rdelim}
		.icon_device_delete {ldelim}background-image:url({$basehref}{$tlImages.inventory_delete}) !important;{rdelim}
		.icon_device_edit {ldelim}background-image:url({$basehref}{$tlImages.inventory_edit}) !important; background-size: 50%;{rdelim}
	</style>
