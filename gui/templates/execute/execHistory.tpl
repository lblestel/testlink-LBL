          ...
          <tr style="border-top:1px solid black; background-color: {$bg_color}">
            <td>
              {if $gui->grants->exec_edit_notes[$tcv_exec.testplan_id]}
                 <img src="{$tlImages.exec_history_note_edit}" style="vertical-align:middle" 
            ...
            {if !$tcv_exec.build_is_open}
              <img src="{$tlImages.exec_history_lock}" title="{$labels.closed_build}">
            {/if}
            *}
            ...
            <img src="{$tlImages.exec_history_user}" title="{$labels.execution_type_manual}"
                 style="border:none" />
            {else}
            <img src="{$tlImages.exec_history_execution_type}" title="{$labels.execution_type_auto}"
                 style="border:none" />
            {/if}
            </td>
          </tr>
