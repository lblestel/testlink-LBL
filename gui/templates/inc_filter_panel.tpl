      ...
      {if $control->draw_export_testplan_button || $control->draw_import_xml_results_button}
        ...
        <tr>
          ...
          <td>
            ...
            <image src="{$tlImages.exec_export_testplan}" title="{$labels.btn_export_testplan_tree}"
                   onclick="javascript: openExportTestPlan('export_testplan','{$session.testprojectID}',
                                                           ...
                                                           '{$control->form_token}');" />
            &nbsp;                                               
            <image src="{$tlImages.exec_export_for_import}" title="{$labels.btn_export_testplan_tree_for_results}"
                   onclick="javascript: openExportTestPlan('export_testplan','{$session.testprojectID}',
            ...
            <image src="{$tlImages.exec_import}" title="{$labels.import_xml_results}"
